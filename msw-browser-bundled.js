...
var import_until4 = __toESM(require_lib(), 1);
...
// lib/browser/index.mjs
var import_until5 = __toESM(require_lib(), 1);
...
var import_until = __toESM(require_lib(), 1);
...
var debug = import_debug.default;
      ...
      queue.push({
        args,
          ...
          try {
            ...
            log('"%s" listener has rejected!', error2);
            reject(error2);
          }
        })
      });
...
var Interceptor = class {
  ...
  getInstance() {
    ...
    this.log("retrieved global instance:", (_a2 = instance == null ? void 0 : instance.constructor) == null ? void 0 : _a2.name);
    return instance;
  }
  setInstance() {
...
// node_modules/@mswjs/interceptors/lib/node/chunk-IC6Y7RGW.mjs
...
var import_cookies = __toESM(require_lib2(), 1);
...
var import_cookies2 = __toESM(require_lib2(), 1);
...
function readResponseCookies(request, response) {
  import_cookies2.store.add(__spreadProps2(__spreadValues3({}, request), { url: request.url.toString() }), response);
...
// lib/core/utils/toResponseInit.mjs
...
// lib/browser/index.mjs
var import_until6 = __toESM(require_lib(), 1);

// lib/core/utils/internal/isObject.mjs
function isObject(value) {
  return value != null && typeof value === "object" && !Array.isArray(value);
}

// lib/core/utils/internal/mergeRight.mjs
...
// node_modules/@mswjs/interceptors/lib/browser/chunk-2GVXYEMC.mjs
...
var debug2 = import_debug2.default;
var AsyncEventEmitter2 = class extends Emitter {
  constructor() {
    super();
    this.log = debug2("async-event-emitter");
    this.queue = /* @__PURE__ */ new Map();
    this.readyState = "ACTIVE";
  }
  on(eventName, listener) {
...
var Interceptor2 = class {
  ...
  dispose() {
    ...
    this.clearInstance();
    log("global symbol deleted:", getGlobalSymbol2(this.symbol));
    if (this.subscriptions.length > 0) {
      log("disposing of %d subscriptions...", this.subscriptions.length);
      for (const dispose of this.subscriptions) {
        dispose();
...
// node_modules/@mswjs/interceptors/lib/browser/chunk-KX4GZMPY.mjs
var import_until2 = __toESM(require_lib(), 1);
var _FetchInterceptor = class extends Interceptor2 {
  ...
  setup() {
    ...
    globalThis.fetch = async (input, init) => {
      ...
      const resolverResult = await (0, import_until2.until)(async () => {
      ...
      if (resolverResult.error) {
        ...
        const error2 = Object.assign(new TypeError("Failed to fetch"), {
...
// node_modules/@mswjs/interceptors/lib/browser/chunk-65HGG3CV.mjs
...
var require_getOwnPropertyDescriptor = __commonJS2({
...
// node_modules/@mswjs/interceptors/lib/browser/chunk-CKVJ2NZB.mjs
var import_until3 = __toESM(require_lib(), 1);
      ...
      methodCall: ([methodName, args], invoke) => {
        ...
        switch (methodName) {
          ...
          case "send": {
            ...
            const onceRequestSettled = ((_a2 = this.onRequest) == null ? void 0 : _a2.call(this, fetchRequest, this.requestId)) || Promise.resolve();
  ...
  const XMLHttpRequestProxy = new Proxy(globalThis.XMLHttpRequest, {
    construct(target, args, newTarget) {
      ...
      requestController.onRequest = async function(request, requestId) {
        ...
        const resolverResult = await (0, import_until3.until)(async () => {
...
var getWorkerInstance = (_0, ..._1) => __async10(void 0, [_0, ..._1], function* (url, options = {}, findWorker) {
  ...
  const registrationResult = yield (0, import_until5.until)(
    () => __async10(void 0, null, function* () {
...
function parseWorkerRequest(incomingRequest) {
  return new Request(incomingRequest.url, __spreadProps3(__spreadValues4({}, incomingRequest), {
    body: pruneGetRequestBody(incomingRequest)
  }));
}
var createRequestListener = (context, options) => {
  return (event, message) => __async10(void 0, null, function* () {
    var _b2;
      ...
      yield handleRequest(
        ...
        context.emitter,
        {
          ...
          onMockedResponse(_0, _1) {
            return __async10(this, arguments, function* (response, { request: request2, handler, parsedRequest }) {
              const responseClone = response.clone();
              const responseInit = toResponseInit(response);
              const responseStream = responseClone.body;
              messageChannel.postMessage(
                "MOCK_RESPONSE",
                __spreadProps3(__spreadValues4({}, responseInit), {
                  body: responseStream
                }),
...
function requestIntegrityCheck(context, serviceWorker) {
  return __async10(this, null, function* () {
    ...
    if (actualChecksum !== "b24acb1451c726c44a3a37a0b8092d67") {
      throw new Error(
        `Currently active Service Worker (${actualChecksum}) is behind the latest published one (${"b24acb1451c726c44a3a37a0b8092d67"}).`
      );
    }
...
function deferNetworkRequestsUntil(predicatePromise) {
  ...
  window.XMLHttpRequest.prototype.send = function(...args) {
    (0, import_until6.until)(() => predicatePromise).then(() => {
      window.XMLHttpRequest.prototype.send = originalXhrSend;
      this.send(...args);
    });
  };
  const originalFetch = window.fetch;
  window.fetch = (...args) => __async10(this, null, function* () {
    yield (0, import_until6.until)(() => predicatePromise);
...
var createStartHandler = (context) => {
  return function start(options, customOptions) {
    const startWorkerInstance = () => __async10(this, null, function* () {
...
Please consider using a custom "serviceWorker.url" option to point to the actual worker script location, or a custom "findWorker" option to resolve the Service Worker registration manually. More details: https://mswjs.io/docs/api/setup-worker/start`,
      ...
      const integrityCheckResult = yield (0, import_until4.until)(
...
If this message still persists after updating, please report an issue: https://github.com/open-draft/msw/issues      `);
    ...
    const workerRegistration = startWorkerInstance().then(
      (registration) => __async10(this, null, function* () {
...
function createFallbackRequestListener(context, options) {
  ...
  interceptor.on("request", (request, requestId) => __async10(this, null, function* () {
...
var SetupWorkerApi = class extends SetupApi {
  ...
  start() {
    return __async10(this, arguments, function* (options = {}) {
